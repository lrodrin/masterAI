...
Teniendo en cuenta toda esta información, para predecir la clase de casos futuros vamos a usar el clasificador *SVMRadial* que es el modelo que ha dado mejores resultados durante el entrenamiento.
...
- Mi repositorio personal en *GitHub* (lrodrin) https://github.com/lrodrin/masterAI/tree/master/A7/Flujo%20de%20an%C3%A1lisis%20en%20clasificaci%C3%B3n%20supervisada%20R-caret