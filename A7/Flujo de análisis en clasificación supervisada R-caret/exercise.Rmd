...
A continuación, cargaremos el conjunto de datos de train y test. Además, nombraremos los valores perdidos como **NA** para que los podamos tratar más adelante. 
...
El conjunto de datos de train contiene 7613 instancias y el conjunto de datos de test contiene 3263 instancias. Cada instancia de los conjuntos de train y test contiene la siguiente información:
...
* **target**: solo en el conjunto de datos de train porqué es la variable clase a predecir. Indica si un tweet es un desastre real (1) o no (0). 
...
```
putting together
las dos matrizes train y test
analizar frequency words
