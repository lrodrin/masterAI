...
No. Porqué el dataset de Titanic solo contiene cuatro atributos diferentes. (ver Figura \ref{Captura_1_2}). 
...
No. El número de conjuntos de ítems de tamaño 1, como máximo, será 9.  Ya que el conjunto, como máximo, puede formarse con los diferentes valores de cada atributo del dataset. En este caso, el dataset de Titanic, contiene 9 valores diferentes, como vemos a continuación:
...
El algoritmo Apriori siempre comienza obteniendo los itemsets más fecuentes de tamaño 1. Donde, el número de ocurrencias de estos es 1. Para comprobarlo experimentalmente, el umbral de confianza debe ser igual a 1. (ver Figura \ref{Captura_1_3})
...
Sí. Lo podemos volver a ver en la Figura \ref{Captura_1_1}.
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.5]{Captura_1_4.png}	% TODO
	\caption{Soporte = 0.75 y confianza = 0.00.}
	\label{Captura_1_4}
\end{figure}
