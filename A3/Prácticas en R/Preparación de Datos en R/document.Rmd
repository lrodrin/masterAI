...
7.3 Using the data frame ‘air’, perform a simple random sampling of 50 examples.

7.4 Using the data frame ‘air’, perform a stratified random sampling of 5 examples of each month.
