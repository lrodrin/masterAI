...
%1
%Kernighan-Lin\cite{KernighanLin} es un método para dividir un grafo que contiene nodos y vértices en subconjuntos separados que están conectados de manera óptima. Dado que se puede usar un grafo para representar una red eléctrica que contiene bloques, el algoritmo Kernighan-Lin se puede extender a la división de circuitos en subcircuitos.
